...
4. **Present Findings & Deliverables (Keep Analysis Concise & Show All Fetched Hits)**:

   - **Recommendation (Short & Direct)**: 2–3 sentences on whether to reuse an existing tool, fork/extend one, or build from scratch.
   - **Top Alternatives Highlight**: Brief summary of the top 2–3 direct solutions found across web search and code registries.
   - **Fetched Registry Hits Table (Mandatory at end)**: Always output a structured markdown table summarizing the fetched discoveries directly from the tool output so the user sees all exact hits without wading through AI prose:
     | Project / Package | Source / Ecosystem                       | Stars / Metric      | Description         |
     | ----------------- | ---------------------------------------- | ------------------- | ------------------- |
     | [owner/repo](url)  | GitHub / GitLab                          | ★ 4,200            | Concise description |
     | [app-name](url)    | Flathub / F-Droid / GNOME                | App ID / Downloads  | Concise description |
     | [pkg-name](url)    | PyPI / npm / Crates / Brew / AUR / Conda | Version / Downloads | Concise description |
